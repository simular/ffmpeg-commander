...
const form = {
  ...
  codecs: {
    ...
    audio: [
      ...
      { name: 'Copy', value: 'copy', supported: null },
      { name: '無', value: 'none', supported: null },
    ],
  },
  presets: [
  ...
  fastStart: [
    { name: '啟用 (faststart)', value: true },
    { name: '無', value: false },
  ],
  sizes: [
    { name: '依照來源', value: 'source' },
    { name: '8K', value: '8192' },
  ...
  formats: [
    { name: '寬螢幕', value: 'widescreen' },
    { name: '全螢幕', value: 'fullscreen' },
  ],
  aspects: [
    { name: '自動', value: 'auto' },
    { name: '1:1', value: '1:1' },
  ...
  extraOptions: [
    { text: '強制輸出格式', value: 'f' },
    { text: '覆蓋既有檔案', value: 'y' },
    { text: '如果有既有檔案，不覆蓋且立刻退出執行', value: 'n' },
    { text: '將輸出結果印至輸出流，適合與其他程式整合', value: 'progress' },
    { text: '不要顯示 Banner', value: 'hide_banner' },
    { text: '將所有訊息印出至： program-YYYYMMDD-HHMMSS.log 於當下目錄', value: 'report' },
  ],
  logLevels: [
    { name: '無', value: 'none' },
